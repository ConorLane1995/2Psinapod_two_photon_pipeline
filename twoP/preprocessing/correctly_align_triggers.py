...
Note: This script only works if the  
...
CSV_PATH = config['Trigger_wrong'] # name of CSV (assumed to be in the folder given in line above) with the trigger voltages over the recording
