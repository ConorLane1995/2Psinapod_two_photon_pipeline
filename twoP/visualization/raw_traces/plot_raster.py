"""
Plots a raster including every cell over the entire recording. A spike is considered anytime the fluoresence trace surpasses SPIKE_THRESHOLD
INPUT: raw_corrected_traces.npy (part of output of epoch_recording.py), nCells x nFrames array (it's exactly like F.npy but with Fneu subtracted)
